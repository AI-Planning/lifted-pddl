...
class LiftedParser:
	...
	instance of the LiftedParser class).
...
# Execute the following code if this script is called from the command line
if __name__ == '__main__':
	...
	#		we print the information encoded in the PDDL domain and problem, according to the format used in LiftedParser.__str__()
